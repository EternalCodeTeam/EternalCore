...
public class ENArgumentMessages extends OkaeriConfig implements ArgumentMessages {
    ...
    Notice noDamaged = Notice.chat("<red>✘ <dark_red>This item can't be repaired");
    Notice noDamagedItems = Notice.chat("<red>✘ <dark_red>You need damaged items to use this command!");
    Notice noEnchantment = Notice.chat("<red>✘ <dark_red>This enchantment doesn't exist");
    Notice noValidEnchantmentLevel = Notice.chat("<red>✘ <dark_red>This enchantment level is not supported!");
    Notice worldDoesntExist = Notice.chat("<red>✘ <dark_red>World <red>{WORLD} <dark_red>doesn't exist!");
    Notice incorrectNumberOfChunks = Notice.chat("<red>✘ <dark_red>Incorrect number of chunks!");
