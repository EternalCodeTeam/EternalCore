...
public class ENGameModeMessages extends OkaeriConfig implements GameModeMessages {
    ...
    Notice gamemodeSet = Notice.chat("<green>► <white>Gamemode now is set to: <green>{GAMEMODE}");

    @Comment("# {PLAYER} - Target player, {GAMEMODE} - Gamemode")
    Notice gamemodeSetToTarget = Notice.chat("<green>► <white>Gamemode for <green>{PLAYER} <white>now is set to: <green>{GAMEMODE}");
}
