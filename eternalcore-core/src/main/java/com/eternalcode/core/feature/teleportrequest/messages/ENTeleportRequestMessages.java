...
public class ENTeleportRequestMessages extends OkaeriConfig implements TeleportRequestMessages {
    ...
    Notice tpaHereSentToAll = Notice
            .chat("<color:#9d6eef>► <white>You have sent a request for teleportation to all players!");
    ...
    Notice tpaDenyNoRequestMessage = Notice
            .chat("<red>✘ <dark_red>You do not have a teleport request from this player!");

    @Comment({ " ", "# {PLAYER} - Player who sent a request to teleport to another player" })
    Notice tpaDenyDoneMessage = Notice
            .chat("<red>✘ <dark_red>You have declined a teleport request from a player: <red>{PLAYER}<dark_red>!");

    @Comment({ " ", "# {PLAYER} - Player who declines the tpa request" })
    Notice tpaDenyReceivedMessage = Notice
            .chat("<red>✘ <dark_red>Player: <red>{PLAYER} <dark_red>rejected your teleport request!");
    ...
    Notice tpaAcceptReceivedMessage = Notice.chat(
            "<color:#9d6eef>► <white>Player: <color:#9d6eef>{PLAYER} <white>accepted your teleportation request!");

    @Comment(" ")
    Notice tpaAcceptAllAccepted = Notice
            .chat("<color:#9d6eef>► <white>All players have accepted your teleport request!");

    @Comment(" ")
    Notice tpaTargetIgnoresYou = Notice.chat("<red>✘ <dark_red>{PLAYER} <red>is ignoring you!");
}
