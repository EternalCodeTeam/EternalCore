...
public class PLJailMessages extends OkaeriConfig implements JailMessages {
    ...
    Notice jailDetainBroadcast = Notice.chat("<color:#9d6eef>► <white>Gracz <color:#9d6eef>{PLAYER} <white>został uwięziony!");
    @Comment({" ", "# {PLAYER} - Gracz który został uwięziony"})
    Notice jailDetainOverride =
        Notice.chat("<color:#9d6eef>► <white>Napisałeś nadaną karę graczowi <color:#9d6eef>{PLAYER}<white>!");
    ...
    Notice jailReleaseBroadcast = Notice.chat("<color:#9d6eef>► <white>Gracz <color:#9d6eef>{PLAYER} <white>został uwolniony!");
