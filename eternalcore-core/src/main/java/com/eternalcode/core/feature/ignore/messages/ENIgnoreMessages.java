...
public class ENIgnoreMessages extends OkaeriConfig implements IgnoreMessages {
    ...
    Notice allPlayersIgnored = Notice.chat("<color:#9d6eef>► <white>All players have been ignored!");
    ...
    Notice playerUnignored = Notice.chat("<color:#9d6eef>► <white>{PLAYER} <white>player has been unignored!");
    Notice allPlayersUnignored = Notice.chat("<color:#9d6eef>► <white>All players have been unignored!");
