...
public class PLDeathMessages extends OkaeriConfig implements DeathMessages {
    ...
    public List<Notice> playerKilledByOtherPlayer = Arrays.asList(
            ...
            Notice.chat(
                    "<white>☠ <dark_red>{PLAYER} <red>został pokonany przez <dark_red>{KILLER} <red>przy użyciu <yellow>{WEAPON}<red>!"),
    ...
    public Map<EntityType, List<Notice>> playerKilledByMobType = new HashMap<>() {
        {
            ...
            put(EntityType.SKELETON, Arrays.asList(
                    ...
                    Notice.chat(
                            "<white>☠ <dark_red>{PLAYER} <red>został zamieniony w poduszkę od igieł przez szkieleta!")));
            ...
            put(EntityType.BLAZE, Arrays.asList(
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został spalony przez Płomyka!"),
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został spalony na popiół przez Płomyka!")));

            put(EntityType.WITHER_SKELETON, Arrays.asList(
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został zabity przez Witherowego Szkieleta!"),
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>uschł od ataku Witherowego Szkieleta!")));
            ...
            put(EntityType.PHANTOM, Arrays.asList(
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został zabity przez Fantoma!"),
            ...
            put(EntityType.PILLAGER, Arrays.asList(
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został zastrzelony przez Rozbójnika!"),
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został napadnięty przez Rozbójnika!")));
            ...
            put(EntityType.VEX, Arrays.asList(
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został zabity przez Dręczyciela!"),
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został zaatakowany przez rój Dręczycieli!")));
            ...
            put(EntityType.PIGLIN_BRUTE, Arrays.asList(
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>został zabity przez Piglina Okrutnika!"),
                    Notice.chat("<white>☠ <dark_red>{PLAYER} <red>rozgniewał Piglina Okrutnika!")));
