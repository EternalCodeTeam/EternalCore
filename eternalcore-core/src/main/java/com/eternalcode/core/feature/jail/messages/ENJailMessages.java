...
public class ENJailMessages extends OkaeriConfig implements JailMessages {
    ...
    Notice jailDetainOverride = Notice
            .chat("<color:#9d6eef>► <white>You have overridden the jail for <color:#9d6eef>{PLAYER} <white>!");
    @Comment({ " ", "# {PLAYER} - Player who has been detained" })
    Notice jailDetainBroadcast = Notice
            .chat("<color:#9d6eef>► <white>Player <color:#9d6eef>{PLAYER} <white>has been jailed!");
    @Comment({ " ", "# {REMAINING_TIME} - Time left to release" })
    @Comment({ " ", "# {REMAINING_TIME} - Time left to release" })
    Notice jailDetainCountdown = Notice
            .actionbar("<red>Remaining time: <color:#9d6eef>{REMAINING_TIME} <red>to release!");
    @Comment({ " ", "# {PLAYER} - Admin who you can't detain" })
    Notice jailDetainAdmin = Notice
            .chat("<red>✘ <dark_red>You can't jail <red>{PLAYER} <dark_red>because he is an admin!");
    ...
    Notice jailReleaseBroadcast = Notice
            .chat("<color:#9d6eef>► <white>Player <color:#9d6eef>{PLAYER} <white>has been granted freedom!");
    Notice jailReleasePrivate = Notice.actionbar("<color:#9d6eef>► <white>You have been released from jail!");
