...
public class PLNearMessages extends OkaeriConfig implements NearMessages {
    ...
    Notice entitiesNotFound = Notice.chat(
            "<red>✘ <dark_red>Nie znaleziono żadnych stworzeń w zasięgu {RADIUS} bloków. Spróbuj ponownie z większym zasięgiem");
    ...
    Notice entitiesFound = Notice.chat(
            "<color:#9d6eef>► <white>Liczba <bold>{ENTITY_AMOUNT}</bold> stworzeń w zasięgu: <bold>{RADIUS} bloków</bold>:");
    ...
    Notice invalidEntityType = Notice
            .chat("<red>✘ <dark_red>Nie podano prawidłowego zakresu entity! Użyj sugerowanej opcji.");
