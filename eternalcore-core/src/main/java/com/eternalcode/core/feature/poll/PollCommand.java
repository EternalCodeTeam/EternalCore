...
public class PollCommand {
    ...
    void executeCreate(Player player, @Arg @Suggest("poll_name") String name, @Arg Duration duration) {
        this.pollManager.startCreatingPoll(player.getUniqueId(), name, duration);
    }
