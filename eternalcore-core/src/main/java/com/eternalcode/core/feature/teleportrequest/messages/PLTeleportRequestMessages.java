...
public class PLTeleportRequestMessages extends OkaeriConfig implements TeleportRequestMessages {
    ...
    Notice tpaSentMessage = Notice
            .chat("<color:#9d6eef>► <white>Wysłałeś prośbę o teleportację do gracza: <color:#9d6eef>{PLAYER}<white>!");

    Notice tpaHereSent = Notice.chat(
            "<color:#9d6eef>► <white>Wysłałeś prośbę o teleportację gracza <color:#9d6eef>{PLAYER}<white> do twojej lokalizacji!");
    Notice tpaHereSentToAll = Notice
            .chat("<color:#9d6eef>► <white>Wysłano prośbę o teleportację do wszystkich graczy!");
    ...
    @Comment(" ")
    Notice tpaDenyNoRequestMessage = Notice
            .chat("<red>✘ <dark_red>Nie otrzymałeś prośby o teleportację od tego gracza!");

    @Comment({ " ", "# {PLAYER} - Gracz który wysłał prośbę o teleportacje do innego gracza" })
    Notice tpaDenyDoneMessage = Notice
            .chat("<red>✘ <dark_red>Odrzuciłeś prośbę o teleportację od gracza: <red>{PLAYER}<dark_red>!");

    @Comment({ " ", "# {PLAYER} - Gracz który odrzucił prośbę o teleportacje" })
    Notice tpaDenyReceivedMessage = Notice
            .chat("<red>✘ <dark_red>Gracz: <red>{PLAYER} <dark_red>odrzucił twoją prośbę o teleportację!");
    ...
    @Comment({ " ", "# {PLAYER} - Gracz który wysłał prośbę o teleportacje do innego gracza" })
    Notice tpaAcceptReceivedMessage = Notice.chat(
            "<color:#9d6eef>► <white>Gracz: <color:#9d6eef>{PLAYER} <white>zaakceptował twoją prośbę o teleportację!");

    @Comment(" ")
    Notice tpaAcceptAllAccepted = Notice.chat("<color:#9d6eef>► <white>Zaakceptowano wszystkie prośby o teleportację!");

    @Comment(" ")
    Notice tpaTargetIgnoresYou = Notice.chat("<red>✘ <dark_red>{PLAYER} <red>ignoruje Cię!");
}
