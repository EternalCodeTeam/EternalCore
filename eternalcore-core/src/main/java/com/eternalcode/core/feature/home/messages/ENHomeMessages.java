...
public class ENHomeMessages extends OkaeriConfig implements HomeMessages {
    ...
    Notice overrideHomeLocationAsAdmin =
        Notice.chat("<color:#9d6eef>► <white>Home <color:#9d6eef>{HOME} <white>has been overridden for <color:#9d6eef>{PLAYER}<white>.");
    Notice playerNoOwnedHomes =
        Notice.chat("<dark_red>✘ <red>Player <dark_red>{PLAYER} <red>doesn't have any homes.");
    Notice createAsAdmin =
        Notice.chat("<color:#9d6eef>► <white>Home <color:#9d6eef>{HOME} <white>has been created for <color:#9d6eef>{PLAYER}<white>.");
    ...
    Notice homeListAsAdmin =
        Notice.chat("<color:#9d6eef>► <white>Available homes for <color:#9d6eef>{PLAYER}<white>: <color:#9d6eef>{HOMES}");
}
