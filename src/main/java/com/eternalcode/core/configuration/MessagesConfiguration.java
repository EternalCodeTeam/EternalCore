...
public final class MessagesConfiguration implements Serializable {
    ...
    public String anvilGuiOpenMessage = "&8» Successfully opened anvil";
    public String cartographyTableGuiOpenMessage = "&8» Successfully opened CartographyTable";
    public String offlinePlayer = "&8» This player is currently offline!";
    public String inventoryCleared = "&8» Your inventory has been cleared!";
    public String disposalTitle = "&f&lTrash!";
    public String disposalGuiOpenMessage = "&8» Successfully opened CartographyTable";
