...
public class PLMessagesConfiguration extends AbstractConfigWithResource implements Messages {
    ...
    public static class PLArgumentSection implements ArgumentSection {
        public String permissionMessage = "&8 » &cNie masz uprawnien do tej komendy! &7({PERMISSIONS})";
        public String offlinePlayer = "&8 » &cTen gracz jest offline!";
        public String onlyPlayer = "&8 » &cKomenda tylko dla graczy!";
        public String notNumber = "&8 » &cArgument nie jest liczba!";
        public String numberBiggerThanOrEqualZero = "&8 » &cLiczba musi byc rowna lub wieksza 0!";
        public String noItem = "&8 » &cMusisz miec item w rece!";
        public String noMaterial = "&8 » &cTaki material nie istenieje!";
        public String noArgument = "&8 » &cTaki argument nie istenieje!";
    }

    @Contextual @Getter @Accessors(fluent = true)
    public static class PLHelpOpSection implements HelpOpSection {
        public String format = "&8 » &8[&c&lHelpOp&8] &e{NICK}&8 » &a{TEXT}";
    ...
    public static class PLAdminChatSection implements AdminChatSection {
        public String format = "&8 » &8[&4Administracja&8] &c{NICK}&8: &7{TEXT}";
    }

    @Contextual @Getter @Accessors(fluent = true)
    public static class PLTeleportSection implements TeleportSection {
        public String actionBarMessage = "&8 » &7Teleportacja za &a{TIME}";
        public String cancel = "&8 » &cRuszyłeś się, teleportacja przerwana!";
        public String teleported = "&8 » &aPrzeteleportowano!";
        public String teleporting = "&8 » &aTeleportuje...";
        public String haveTeleport = "&8 » &cTeleportujesz się już!";
    }
    ...
    public static class PLChatSection implements ChatSection {
        ...
        public String alreadyDisabled = "&8 » &cCzat jest juz wylaczony!";
        public String alreadyEnabled = "&8 » &cCzat jest juz wlaczony!";
    ...
    public static class PLOtherMessages implements OtherMessages {
        ...
        public String nullHatMessage = "&8 » &cNie możesz użyć /hat!";
        ...
        public String speedBetweenZeroAndTen = "&8 » &cUstaw speed w przedziale 0-10!";
        ...
        public String spawnNoSet = "&8 » &cSpawn nie jest ustawiony!";
        ...
        public String gameModeNotCorrect = "&8 » &cNie prawidłowy typ!";
        ...
        public List<String> whoisCommand = Arrays.asList("&8 » &7Gracz &8 » &5{PLAYER}",
            "&8* &7UUID &8» &d{UUID}",
            "&8* &7IP &8» &d{IP}",
            "&8* &7Szybkość chodzenia &8» &d{WALK-SPEED}",
            "&8* &7Szybkość latania &8» &d{SPEED}",
            "&8* &7Opóźnienie &8» &d{PING}ms",
            "&8* &7Poziom &8» &d{LEVEL}",
            "&8* &7Zdrowie &8» &d{HEALTH}",
            "&8* &7Poziom najedzenia &8» &d{FOOD}");
    }
